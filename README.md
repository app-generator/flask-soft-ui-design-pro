# [Soft UI Design PRO Flask](https://appseed.us/product/flask-soft-ui-design-pro)

**Soft UI Design PRO** is a premium design crafted by the `Creative-Tim` agency on top of Bootstrap 5 Framework. Designed for those who like bold elements and beautiful websites, Material Kit 2 is made of hundreds of elements, designed blocks, and fully coded pages built with an impressive level of quality. The **Flask** codebase provides the bare minimum essentials to start fast a new project.
...
---
[Soft UI Design PRO Flask](https://appseed.us/product/flask-soft-ui-design-pro) - Provided by **AppSeed** [App Generator](https://appseed.us/app-generator).
